            ...
            <section class="profile-section text-center">
              <figure class="user-profile-photo" role="presentation">
                <div class="polygon">
                 ...
                 <nuxt-link  class="circle-progress-link" 
                :to="{ name: 'perfil-user', params: {user: userName} }" >
     ...
     :id_actor="id_user" :tipo="5" @getSeguidores="getMisSecciones()" v-if="id_user_login != id_user" />
        ...
        <ol class="artists-list mt-md">
					<li class="mb-lg" v-for="(actor, index) in arrayMisActores" :key="index">
								 <nuxt-link 
	:to="{name:'actor-slug', params: {slug: actor.slug+'.'+actor.id_actor} }">    
       ...
       <nuxt-link  v-for="(movie, index) in arrayMisColecciones" :key="index"
          :to="{ name: 'colecciones-username-slug', params: {username: userName, slug: movie.slug} }">
	...
	<ul>
		...
		<VotoForo :id_user="id_user" :id_tema="String(movie.id)" :login="login" />
			...
			<h3 class="title-tertiary truncate mt-0 mb-0">
                  <nuxt-link 
	:to="{name:'foro-foro_slug-tema_slug', params: {foro_slug: movie.slugForo, tema_slug: movie.slug+'.'+movie.id} }">
                 <font style="vertical-align: inherit;">
                ...
                <font style="vertical-align: inherit;">
                    <font style="vertical-align: inherit;">
                        ...
                        <font style="vertical-align: inherit;">por </font>
                         ...
                         <nuxt-link class="item"   
                            :to="{ name: 'perfil-user', params: {user: movie.autor} }">
                        <font style="vertical-align: inherit;">
                            <font style="vertical-align: inherit;">{{movie.autor}}</font>
                            </font></nuxt-link><font style="vertical-align: inherit;">
                        <font style="vertical-align: inherit;"> .</font>
                </font>
            </p>
		</li>
