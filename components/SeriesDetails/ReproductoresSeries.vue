<template>
  ...
  <div id="series-tabs" class="ui pointing secondary menu">
       ...
       <nuxt-link   class="item navigate navigate-prev right" :class="{'disabled': temporada_anterior == 0}"
        ...
        params: {slug: $route.params.slug, id_temp: temporada_anterior, id_cap: capitulo_anterior } }">
			...
			Capítulo Anterior</nuxt-link>

<nuxt-link  class="item navigate navigate-next" :class="{'disabled': temporada_siguiente == 0}"
        :to="{ name: 'series-slug-temporada-id_temp-capitulo-id_cap', 
