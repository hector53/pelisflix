...
metaArray[6].content = metaArray[6].content.replace("api.pelismania.co", store.state.siteUrlSeo)+"temporada/"+params.id_temp
...
metaArray[0].content = "Ver "+seoDetails.data[0].title.rendered+" Temporada "+params.id_temp+
" Completa Online ✅ Serie "+seoDetails.data[0].title.rendered+" Temporada "+params.id_temp+
" en Latino, Castellano y Subtitulado Gratis en HD."
metaArray[5].content = "Ver "+seoDetails.data[0].title.rendered+" Temporada "+params.id_temp+
" Completa Online ✅ Serie "+seoDetails.data[0].title.rendered+" Temporada "+params.id_temp+
" en Latino, Castellano y Subtitulado Gratis en HD."
   ...
   data (){
      ...
      SeriesDetails: [], 
            tabTemp: this.$route.params.id_temp, 
              id_user: null, 
          userName: null,
          post_id: null,
          verCaps: 10, 
